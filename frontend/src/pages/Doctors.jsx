...
const Doctors = () => {
    ...
    useEffect(() => {
        applyFilter()
    }, [doctors, speciality, searchTerm])   // re-run on searchTerm change
        ...
        <div>
            ...
            <div className='mt-4'>
                <input
                    ...
                    className='w-full sm:w-1/2 px-3 py-2 border border-gray-400 rounded-lg outline-none focus:ring-2 focus:ring-blue-400'
                />
            </div>
