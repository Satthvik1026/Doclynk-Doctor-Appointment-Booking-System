...
import '../assets/assets_frontend/assets'
...
const MyProfile = () => {
    ...
    return userData && (
        <div className='max-w-lg flex flex-col gap-2 text-sm'>
                ...
                isEdit
                    ? <label htmlFor='image'>
                        <div className='inline-block relative cursor-pointer'>
                            ...
                            {/* Use overlay for better positioning, or adjust 'absolute' values */}
            ...
            {
                isEdit ? <input className='bg-gray-50 text-3xl font-medium mx-w-60 mt-4' type='text' value={userData.name} onChange={e => setUserData(prev => ({ ...prev, name: e.target.value }))} />
            ...
            <div>
                ...
                <div className='grid grid-cols-[1fr_3fr] gap-y-2.5 mt-3 text-neutral-700'>
                    ...
                    {
                        isEdit ?
                            <input className='mex-w-28 bg-gray-100' type='date' value={userData.dob} onChange={e => setUserData(prev => ({ ...prev, dob: e.target.value }))} />
